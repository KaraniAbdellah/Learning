...
CREATE TABLE school(
	s_id NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
	CONSTRAINT school_id_con PRIMARY KEY (s_id)
);
DROP TABLE school;
SELECT * FROM school;
ALTER TABLE school DROP CONSTRAINT s_id; -- you should put name OF CONSTRAINT NOT COLUMN ID
ALTER TABLE school DROP CONSTRAINT school_id_con;
ALTER TABLE school ADD CONSTRAINT school_id_con PRIMARY KEY (s_id);
ALTER TABLE school DISABLE CONSTRAINT school_id_con;  -- does NOT WORK
ALTER TABLE school ENABLE CONSTRAINT school_id_con;  -- does NOT WORK
ALTER TABLE school RENAME CONSTRAINT school_id_con TO s_id_con;
